...
if (!$resultb) 
	...
	?>
<html>
<title>Amended Proposed Drawings </title>
<head>
...
<input name="title" id="title" type="hidden" value="Amended Proposed Drawings (<?php echo $QuoteID; ?>)">
...
<p>Dear <?php echo $clientContactName; ?></p> <br/> <br/> 


<p>Please find enclosed a copy of the amended working drawings of the proposed Vergola as discussed with David Moffett. These drawings are very important and they form part of your contract. Accordingly we request that you review the drawings and let us know if there are any issues or inconsistencies. </p>
<br/>
...
<br/>
<p>Please return the signed copy via fax to 08 8150 6868 or post to,</p>
<br/>
<p>101 Port Road, Thebarton SA 5031.</p>
<br/>
