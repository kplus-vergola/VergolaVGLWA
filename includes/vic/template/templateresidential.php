...
if (!$resultb) 
	...
	?>
<html>
<title>Template Residential</title>
<head>
...
<input name="title" id="title" type="hidden" value="Template Residential">
...
<table class="template_tbl" cellspacing="0" cellpadding="0"><tr><td valign="bottom" style="font-family:Arial, Helvetica, sans-serif;font-size:11pt;width:75%;vertical-align:bottom;">
...
<p>Re: Preliminary Quote for Vergola Roof Systems – No Frame</p>
<p>Project: <?php echo $SiteAddress1; ?></p>
<p>Thank you for taking the time to discuss the project with us.</p>
<p>We are pleased that you are looking to incorporate a Vergola as part of your project.</p>
...
<p>We are pleased to provide our quote for supply and installation of a {SINGLE / DOUBLE BAY FLAT Vergola spanning approximately 0.0m x 0.0m OR divided into 2 bays}</p>

Cost:		$00 000.00 + GST<br/>
Total Cost:	$00 000.00<br />

<p>Supply & Installation:</p>
<ul><li>Vergola Colorbond Gutters</li>
<li>Colorbond Flashings</li>
<li>Vergola Colorbond louvers</li>
<li>Die cast aluminium end caps</li>
<li>Link bars & pivot strips</li>
<li>Down pipes & fittings to ground or existing downpipes</li>
<li>Automatic switching including rain Sensor</li>
<li>Vergola remote control</li>  
<li>Vergola motors</li>
<li>Opaque enclosure to house Vergola control system</li>
<li>(Colours – Surfmist, Shale Grey, Classic Cream, Woodland Gray or Paperbark only)</li>
</ul>

<p>Exclusions:</p>

<ul><li>Connection of down pipes to stormwater</li>
<li>Supply of a 240 V power point</li> 
<li>Crane hire to mobilise equipment & beams, louvres & flashings, de-mobilise.</li>
<li>Council permits for crane & traffic control during crane use.</li></ul>

<p>We wish to confirm our requirements for the framework as follows:</p>

<ul>
<li>Framework can be of any structural member (eg C section, RHS or LVL) provided such beam has a minimum depth of 250mm for a flat Vergola or 200mm for a sloped Vergola.</li>
...
<li>All framework must be square and plumb.</li></ul>
...
<ul><li>a 240V GPO where the control box is to be mounted</li></ul>

<p>We trust that you find our quote to be acceptable and look forward to working with you on this exciting project.  Please do not hesitate to contact us should you wish to discuss any aspect of this quote.</p>
<p>Yours sincerely</p>
<?php echo $RepName; ?><br />
TITLE: <?php echo $RepIdent; ?><br />
Vergola SA Pty Ltd<br />
</textarea>
