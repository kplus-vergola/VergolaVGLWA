...
<input name="title" id="title" type="hidden" value="Client Authority - (<?php echo $QuoteID; ?>)">
...
<table class="template_tbl" cellspacing="0" cellpadding="0">
	<tr>
		...
		<br/>
		<p>Re:		Authority to act as applicant on behalf of our client. </p>
		<br/>
		<p>Site Address: <?php echo $SiteAddress1.' '.$SiteAddress2; ?> <br/>  
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<br/>
<p>I/We the owners of the project described above authorise VERGOLA Victoria to act as the applicant on our behalf in lodging all applications for Building Permits, Planning and Development approvals, Modifications to the Building Regulations, Dispensations, Consent and Reports relating to dispensations and such other matters which may be required in order to facilitate the approvals necessary to construct the above project</p>
<br/>
<p>It is acknowledged that VERGOLA is acting on our behalf and consequently,
ALL or ANY stated responsibilities of the applicant referred to in the consent approval issued by the approving authority, are those of us, as owners of the property/development.
</p>
<br/>
<p>We acknowledge that VERGOLA in no way holds responsibility or liability as the applicant.</p>
