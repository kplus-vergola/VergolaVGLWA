...
if (!$resultb) 
	...
	?>
<html>
<title>Proposed Drawing With Rescode</title>
<head>
...
<input name="title" id="title" type="hidden" value="Proposed Drawing Rescode (<?php echo $QuoteID; ?>)">
...
<b>Re: &nbsp;&nbsp;&nbsp; Proposed Vergola at <?php echo $SiteAddress1 .' '. $SiteAddress2.' '. $SiteSuburb.' '.$SiteState; ?><br/></b><br/> 
<br/>
<p>Please find enclosed copies of the working drawings of the proposed Vergola, these drawings are very important and they form part of your contract. Accordingly we request that you review the drawings and let us know if there are any issues or inconsistencies. </p>
<br/>
<p>Our Building Surveyors (JNAT) have assessed you application and requested the following items at this stage.</p>
<br/>
&nbsp;&nbsp;&nbsp;&nbsp; 1.	&nbsp;&nbsp;&nbsp; Town Planning Permit is required.<br/><br/>

<p>If we are made aware of any further requirements we will let you know accordingly.</p><br/> 

<p>If you are satisfied please sign and return a copy of the drawings in the envelope provided so that we can proceed with obtaining the Building Permit for you. The remaining copy is for your records.</p>
<br/> 
In the event of any queries, please do not hesitate to contact me on 1800 837 4652.<br/><br/><br/><br/>
