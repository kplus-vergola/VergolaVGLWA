...
if (!$resultb) 
	...
	?>
<html>
<title>Protection Work Notice Client</title>
<head>
...
Dear <?php echo $clientContactName; ?>,<br/><br/>
<p >Please find enclosed the Protection Works Notice documents for you to present to your neighbours at Unit 101 and 102 as per your previous email conversations with my colleague Jess.</p>
<br/> 
<p >
As the cover letters to each neighbour state; please get them to fill in, sign and date the Protection Work ‘Response’ Notice and return it to us at your earliest convenience using the replied paid envelope(s) enclosed so we may start the next stage of applications. The Protection Work Notice first page is for your neighbours records.
</p>
<br/> 
<p >
