...
<input name="title" id="title" type="hidden" value="Color Chart - (<?php echo $QuoteID; ?>)">
...
<table  >
	<tr>
		...
		<td width="70%">
			<p style="float:left; font-weight:bold; font-size:15pt; padding-left:51px">
				Colour Chart
			</p>
		</td>
	</tr>
	<tr>
		<td>Date</td><td><?php print(Date("d M Y")); ?></td>
	</tr>
	<?php
		$clientContactName = "";
		if($QuoteIDAlpha == "CRV") {
	...
	?>
		...
		<tr> 
			<td>Customer Name</td><td><?php echo $clientContactName ; ?> </td>
		</tr>
		<tr> 	
			<td>Street Address</td><td><?php echo $ClientAddress1 .' '. $SiteAddress2; ?></td>
		</tr>
		<tr> 	
			<td>Suburb</td><td><?php echo $ClientSuburb .' '. $ClientState.' '. $ClientPostCode; ?></td>
		</tr> 
		...
		<tr> 	
			<td>Street Address</td><td><?php echo $BuildAddress1 .' '. $BuildAddress2; ?></td>
		</tr>
		<tr> 	
			<td>Suburb</td><td><?php echo $BuildSuburb .' '. $BuildState.' '. $BuildPostcode; ?></td>
		</tr>   
...
<img src="<?php echo JURI::base().'images/color_char_image_template.jpg'; ?> "  />
<br/><br/><br/><br/>
 <p>Customer to  Sign Off _______________________________________________________________</p>
</div> 
</textarea>
