...
if (!$resultb) 
	...
	?>
<html>
<title>Build Over Easement</title>
<head>
...
<input name="title" id="title" type="hidden" value="Build Over Easement (<?php echo $QuoteID; ?>)">
...
<table class="template_tbl" cellspacing="0" cellpadding="0">
	<tr>
		<td   style="font-family:Arial, Helvetica, sans-serif;font-size:11pt; " colspan="2" width="80%">
		...
		<td width="20%">
			<img src="<?php echo JURI::base().'images/template-logo-new.jpg'; ?> " class="template_img"   align="right" style="  height: 250px; " /> 
		</td> 
	</tr>
	<tr>
		<td width="15%">
		...
		<td width="65%">
			<b>Build Over Easement Approval Request - Vergola Sun Control System</b><br/><br/>
	...
	<tr>
		...
		<td width="65%"> 
			<b><?php echo $SiteAddress1 .' '. $SiteAddress2.' '. $SiteSuburb.' '.$SiteState; ?></b> 
 		</td>
		<td width="20%">
...
Please find attached the following documentation:<br/><br/>


&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1.	Barwon Water Application Form <br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2.	Cheque Payment $86.28  <br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3.	Authority for Development  <br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;4.	Certificate of Title <br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;5.	Dial Before You Dig information <br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;6.	Plans  <br/>

<br/> <br/>
If you require any further information please contact me on 03 9988 2880 or by email: reception@vergola.com. <br/>
 <br/> <br/> <br/>
