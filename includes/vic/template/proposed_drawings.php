...
<input name="title" id="title" type="hidden" value="Proposed Drawing - (<?php echo $QuoteID; ?>)">
<textarea name="htmlcontent" id="htmlcontent" class="mce_editable" style="width:100%;height:100%!important;">
<div class="mceNonEditable" style="font-family:Arial, Helvetica, sans-serif;font-size:11pt; width:700px; ">
<table class="template_tbl" cellspacing="0" cellpadding="0">
<tr>
	<td valign="bottom" style="font-family:Arial, Helvetica, sans-serif;font-size:11pt;width:75%;vertical-align:bottom;">
		...
		<p>Dear <?php echo $clientContactName; ?></p>
	</td>
	<td style="width:25%">
		<img src="<?php echo JURI::base().'images/template-logo-new.jpg'; ?> " class="template_img" style="float:right;padding:0px 20px 10px; width: 110px;"/>
	</td>
</tr>
...
<br/> 
<br/> 
<p>Please find enclosed a copy of the working drawings of the proposed Vergola, these drawings are very important and they form part of your contract. Accordingly we request that you review the drawings and let us know if there are any issues or inconsistencies. </p>
<br/> 

<p>Otherwise if you are satisfied please sign and return a copy of the drawings so that we can proceed with obtaining the Building Permit for you.</p>
<br/> 
 
<p>In the event of any queries, please do not hesitate to contact me on 1800 837 4652.</p>
<br/>  
<br/> 
<p>Kind regards  </p>
<br/> <br/> 
...
Renee Penley <br/>
Administration <br/>
<b>Vergola (VIC) Pty Ltd </b><br/>
 </p>

</div>
 
</textarea>
<input type="submit" class="btn" name="add" id="add" value="Save"> <input class="btn" type="button" value="Close" onClick="window.opener=null; window.close(); return false;">
