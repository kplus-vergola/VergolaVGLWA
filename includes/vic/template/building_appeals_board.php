...
if (!$resultb) 
	...
	?>
<html>
<title>Building Appleals Board</title>
<head>
...
<input name="title" id="title" type="hidden" value="Building Appeals Board (<?php echo $QuoteID; ?>)">
...
<table class="template_tbl" cellspacing="0" cellpadding="0">
	<tr>
		...
		<p><?php print(Date("d M Y")); ?></p><br/> <br/><br/>
		The Registrar <br/>
		Building Referees Board<br/>
		PO Box 536<br/>
...
<p >
Please find attached documents regarding a "Modification to the Building Regulation" at  <?php echo $SiteAddress1 .' '. $SiteAddress2.' '. $SiteSuburb.' '.$SiteState; ?>. The modification sought to Regulation P2.3.1 of the Building Code of Australia 1996 would allow a louvre roofed verandah extension to be built within 500mm of the property boundary.
</p><br/><br/>

<p >
The flooring of the area is a low level timber deck approximately 200mm above the ground.  As shown on Drawing Number VIC- 245-2 the verandah roof posts are located 500mm from the boundary of the property which has a 1.8m high timber fence.
</p><br/><br/>

<p  >
The actual attached verandah framework is made from non combustible steel posts and beams, while the roof is made from Colorbond steel louvres. The nearest buildings on the adjoining properties are over 6.0 metres away.  With the above submission to hand, I request that this modification to regulation P2.3.1 be now allowed. 
</p><br/><br/>

<p >
We believe adding the proposed structure would not provide a significant increase in the fire risk to the adjoining property. 
</p><br/><br/>

<p >
If you have any questions, please do not hesitate to call me during office hours on 
0412 171 414.
</p><br/><br/>
