...
if (!$resultb) 
	...
	?>
<html>
<title>Rescode check Letter</title>
<head>
...
<input name="title" id="title" type="hidden" value="Res Code Letter (<?php echo $QuoteID; ?>)">
...
<p>Dear <?php echo $clientContactName; ?></p><br/>


<p><b>Re: &nbsp;&nbsp;&nbsp; Proposed Vergola at <?php echo $SiteAddress1 .' '. $SiteAddress2.' '. $SiteSuburb.' '.$SiteState; ?> </b></p><br/>
<br/>

	<p> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 1.  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Our Building Surveyors (JNAT) have assessed your application and requested the following item  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; at this stage:</p>
	<br/>
	<p> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  a) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Town Planning Permit and endorsed plans required.</p>
	<br/>
	<p style="margin-left:30px;"> 
		We will apply for this on your behalf and charge you accordingly.
	If we are made aware of any further requirements we will let you know.
	</p>
	<br/><br/>
