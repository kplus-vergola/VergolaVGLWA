...
if (!$resultb) 
	...
	?>
<html>
<title>Report and Consent</title>
<head>
...
<input name="title" id="title" type="hidden" value="Report and Consent (<?php echo $QuoteID; ?>)">
...
<div style="font-family:Arial, Helvetica, sans-serif; width:700px;  font-size: 11pt;">
 ...
 <table class="template_tbl" cellspacing="0" cellpadding="0"  >
	<tr>
		...
		<img src="<?php echo JURI::base().'images/template-logo-new.jpg'; ?> "  style="  height: 250px; "/>
		</td>
	</tr>
	<tr>
		<td width="15%">
		...
		<td width="65%">	 
			<b >Application for Report and Consent (corresponding to Amend a Planning Permit  application MPS 2011/719 sent --/--/--) 
			Build Over Easement</b>  
		</td>
		<td width="20%" >
		</td>
	</tr>
	<tr>
		...
		<td width="65%">	  
			<b> <?php echo $SiteAddress1 .' '. $SiteSuburb.' '.$SiteState; ?></b> 
		</td>
		<td width="20%" >
		</td>
	</tr>
...
Please find attached the following documentation:<br/><br/><br/>

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1.&nbsp;     Application for Report and Consent of Council – Build Over Easement<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2.&nbsp; 	 Application Fee  $317.00<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3.&nbsp;	 Lands & Titles Certificates<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;4.&nbsp;	 Plans (3 copies) <br/>

<br/><br/><br/>

If you require any further information please contact me on 9988 2880 or by email: reception@vergola.com.<br/><br/><br/>
