...
if ($getQty[23] != '0.00') {
	echo "<tr id=\"stdgutter8\" style=\"display: table-row;\"><td><input type=\"hidden\" name=\"id[23]\" value=\"{$getCFID[23]}\" /><select class=\"desclist\" name=\"desclist[]\" >";
...
else {echo "<tr id=\"stdgutter8\" style=\"display: none;\"><td><input type=\"hidden\" name=\"id[23]\" value=\"{$getCFID[23]}\" /><select class=\"desclist\" name=\"desclist[]\" >";
        foreach($gutters as $gutter) {
      	echo "<option value=\"".$gutter['cf_id']."\"";
		if($gutter['cf_id'] == $getID[23]){ 
		echo "selected=\"selected\""; 
