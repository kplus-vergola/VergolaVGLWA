        ...
        $html = "<form method='post' action='".JURI::base()."contract-listing-vic/contract-folder-vic/contract-bom-vic' >
                ...
                <div class='item-dimension-content' style='width:700px;'>
                    ...
                    <div class='content-right'>                     
                        ...
                        <p><label>F :</label><input type='text' name='dimension_f' value='{$dimension["dimension_g"]}' /></p>
                        <p><label>F :</label><input type='text' name='dimension_f' value='{$dimension["dimension_h"]}' /></p>
