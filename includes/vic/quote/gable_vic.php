<?php
//error_log("Inside gable.php", 3,'C:\\xampp\htdocs\\vergola_contract_system_v3\\my-error.log');//exit;
$next_increment = 0;
...
//&& $cnt == $cnt2 && $cnt2 == $cnt3 && $cnt3 == $cnt4 && $cnt4 == $cnt5 && $cnt5 == $cnt6 && $cnt6 == $cnt7 && $cnt7 == $cnt8 && $cnt8 == $cnt9
if ($cnt > 0) {
    $insertArr = array();
...
if(isset($_POST['save-close-gable']))
{	
$ProjectName = $_POST['projectsite'];
$DateQuote = $_POST['quotedate'];
$FrameworkTYP = $_POST['frameworktype'];
...
$resultcbeam200 = mysql_query("SELECT cf_id, inventoryid, description, uom, rrp, cost FROM ver_chronoforms_data_inventory_vic WHERE section = 'Frame' and category = 'CBeams' or category = 'Timber'" );
...
echo "</select>";
$datacbeam = mysql_query("SELECT cf_id, inventoryid, description, uom, rrp, cost  FROM ver_chronoforms_data_inventory_vic WHERE section = 'Frame' and category  = 'CBeams' and cf_id = '1'" );
...
echo "<tbody class=\"tbody_none_framework\">";
echo "<tr><th>Description</th><th>Webbing</th><th>Colour</th><th>Finish</th><th>UOM</th><th>QTY</th><th>Length</th><th>RRP</th></tr>";
