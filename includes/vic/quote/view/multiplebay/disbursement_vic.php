...
//Display None THESE PART BECAUSE IT IS NOT PART OF THE ITEMS.
//I INCLUDE ADDITIONAL ITEM IN THE LAST PART TO COMPLATE THE CORRECT LIST.
echo "<tr style=\"display:none\"><td><input type=\"hidden\" name=\"id[65]\" value=\"{$getCFID[65]}\" />";
        $disburses = array();
...
// Total RRP
echo "<td><input type=\"text\" class=\"rrpd\" readonly=\"readonly\" name=\"rrp[65]\" value=\"{$getRRP[65]}\"><input type=\"hidden\" class=\"cstd\" name=\"cst[65]\" value=\"{$getCost[65]}\"></td>";
echo "</tr>";
...
// Total RRP
echo "<td><input type=\"text\" class=\"rrpd\" readonly=\"readonly\" name=\"rrp[66]\" value=\"{$getRRP[66]}\"><input type=\"hidden\" class=\"cstd\" name=\"cst[66]\" value=\"{$getCost[66]}\"></td>";
echo "</tr>";
...
// Total RRP
echo "<td><input type=\"text\" class=\"rrpd\" readonly=\"readonly\" name=\"rrp[82]\" value=\"{$getRRP[82]}\"><input type=\"hidden\" class=\"cstd\" name=\"cst[82]\" value=\"{$getCost[81]}\"></td></tr>";
?>