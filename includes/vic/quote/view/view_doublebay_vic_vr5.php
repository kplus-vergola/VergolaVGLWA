...
function generateRowItemVR5($section,$projectId=null){
	...
	if($section=="frame"){  
		...
		while ($r = mysql_fetch_assoc($fw)) { 
	 	...
	 	$isFirst = 1; $isSecond = 0; $isSecond2=0; $isThird = 0;$isFourth = 0; $isFifth = 0; $isFifth2=0; $isSixth=0; $isSeventh=0; $isEighth=0;
		...
		while ($r = mysql_fetch_assoc($fw)) { 
			...
			if($isFirst || $isSecond || $isSecond2){
				$itemName = listItem("louvres",$r,null,"poly".($isFirst?"1":($isSecond?"2":"3")));
