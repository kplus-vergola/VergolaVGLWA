...
echo "<tr><td><input type=\"hidden\" name=\"id[37]\" value=\"{$getCFID[37]}\" />".$getDesc[37];
        $miscitems = array();
		while ($miscitems = mysql_fetch_array($resultmiscitems)) {
		$miscitems[] = $miscitem; 	}	
      	foreach($miscitems as $miscitem) {
		if ($miscitem['cf_id'] == $getID[37]) {  
		echo "<input type=\"hidden\" class=\"desc\" name=\"desc[37]\" value=\"".$miscitem['description']."\" readonly=\"readonly\" />".
		"<input type=\"hidden\" class=\"invent\" name=\"invent[37]\" value=\"".$miscitem['inventoryid']."\" readonly=\"readonly\" />".
...
// Unit of Measurement
echo "<td><input type=\"text\" name=\"uom[37]\" readonly=\"readonly\" value=\"{$getUOM[37]}\"></td>";	
// Unit Quantity
...
echo "<tr><td><input type=\"hidden\" name=\"id[38]\" value=\"{$getCFID[38]}\" />".$getDesc[38];
      	...
      	foreach($miscitems as $miscitem) {
		if ($miscitem['cf_id'] == $getID[38]) {  
		echo "<input type=\"hidden\" class=\"desc\" name=\"desc[38]\" value=\"".$miscitem['description']."\" readonly=\"readonly\" />".
		"<input type=\"hidden\" class=\"invent\" name=\"invent[38]\" value=\"".$miscitem['inventoryid']."\" readonly=\"readonly\" />".
		"<input type=\"hidden\" class=\"descrrp\" name=\"descrrp\" value=\"".$miscitem['rrp']."\" readonly=\"readonly\" />".
        "<input type=\"hidden\" class=\"desccost\" name=\"desccost\" value=\"".$miscitem['cost']."\" readonly=\"readonly\" /></td>";
...
// Unit of Measurement
echo "<td><input type=\"text\" name=\"uom[38]\" readonly=\"readonly\" value=\"{$getUOM[38]}\"></td>";	
// Unit Quantity
