...
echo "<tr><td><input type=\"hidden\" name=\"id[58]\" value=\"{$getCFID[58]}\" />".$getDesc[58];
	$miscitems = array();
	...
	if(count($miscitems)){
	  	foreach($miscitems as $miscitem) {
			if ($miscitem['cf_id'] == $getID[58]) {  
			echo "<input type=\"hidden\" class=\"desc\" name=\"desc[58]\" value=\"".$miscitem['description']."\" readonly=\"readonly\" />".
			"<input type=\"hidden\" class=\"invent\" name=\"invent[58]\" value=\"".$miscitem['inventoryid']."\" readonly=\"readonly\" />".
...
// Unit of Measurement
echo "<td><input type=\"text\" name=\"uom[58]\" readonly=\"readonly\" value=\"{$getUOM[58]}\"></td>";	
// Unit Quantity
...
echo "<tr><td><input type=\"hidden\" name=\"id[59]\" value=\"{$getCFID[59]}\" />".$getDesc[59];
    if(count($miscitems)){
      	foreach($miscitems as $miscitem) {
		if ($miscitem['cf_id'] == $getID[59]) {  
		echo "<input type=\"hidden\" class=\"desc\" name=\"desc[59]\" value=\"".$miscitem['description']."\" readonly=\"readonly\" />".
		"<input type=\"hidden\" class=\"invent\" name=\"invent[59]\" value=\"".$miscitem['inventoryid']."\" readonly=\"readonly\" />".
		"<input type=\"hidden\" class=\"descrrp\" name=\"descrrp\" value=\"".$miscitem['rrp']."\" readonly=\"readonly\" />".
        "<input type=\"hidden\" class=\"desccost\" name=\"desccost\" value=\"".$miscitem['cost']."\" readonly=\"readonly\" /></td>";
...
// Unit of Measurement
echo "<td><input type=\"text\" name=\"uom[59]\" readonly=\"readonly\" value=\"{$getUOM[59]}\"></td>";	
// Unit Quantity
...
// ***************************** Add Misc ********************************************//
echo "<tr id=\"extra1\" style=\"display: table-row\"><td><input type=\"hidden\" name=\"id[60]\" value=\"{$getCFID[60]}\" /><select class=\"desclist\" name=\"desclist[]\" >";
...
echo "<input type=\"hidden\" class=\"desc\" name=\"desc[60]\" value=\"".$misc['description']."\" readonly=\"readonly\" />".
     "<input type=\"hidden\" class=\"invent\" name=\"invent[60]\" value=\"".$misc['inventoryid']."\" readonly=\"readonly\" />".
     ...
     "<input type=\"hidden\" class=\"desccost\" name=\"desccost\" value=\"".$misc['cost']."\" readonly=\"readonly\" />"; }
		...
		echo "</td>";
// Webbing
echo"<td><input type=\"button\" value=\"Remove Misc\" onclick=\"hidextra1();\" id=\"removextra1\"><input type=\"hidden\" class=\"webbing\" name=\"webbing[60]\" value=\"\" readonly=\"readonly\" /></td>";
...
// Unit of Measurement
echo "<td><input type=\"text\" name=\"uom[60]\" id=\"uom\" readonly=\"readonly\" value=\"".$misc['uom']."\"></td>";
		
// Unit Quantity
echo "<td><input type=\"text\" id=\"addqty24\" name=\"qty[60]\" value=\"{$getQty[60]}\"></td>";
...
echo "<input type=\"hidden\" class=\"desc\" name=\"desc[61]\" value=\"".$extra['description']."\" readonly=\"readonly\" />".
	 ...
	 echo "</td>";
// Webbing
echo"<td><input type=\"button\" value=\"Remove Extras\" onclick=\"hidextra2();\" id=\"removextra2\"><input type=\"hidden\" class=\"webbing\" name=\"webbing[61]\" value=\"\" readonly=\"readonly\" /></td>";
...
// Unit Quantity
echo "<td><input type=\"text\" id=\"addqty25\" name=\"qty[61]\" value=\"{$getQty[61]}\"></td>";
...
echo "<input type=\"hidden\" class=\"desc\" name=\"desc[62]\" value=\"".$extra['description']."\" readonly=\"readonly\" />".
	 ...
	 echo "</td>";
// Webbing
echo"<td><input type=\"button\" value=\"Remove Extras\" onclick=\"hidextra3();\" id=\"removextra3\"><input type=\"hidden\" class=\"webbing\" name=\"webbing[62]\" value=\"\" readonly=\"readonly\" /></td>";
...
// Unit Quantity
echo "<td><input type=\"text\" id=\"addqty26\" name=\"qty[62]\" value=\"{$getQty[62]}\"></td>";
...
echo "<input type=\"hidden\" class=\"desc\" name=\"desc[63]\" value=\"".$extra['description']."\" readonly=\"readonly\" />".
	 ...
	 echo "</td>";
// Webbing
echo"<td><input type=\"button\" value=\"Remove Extras\" onclick=\"hidextra4();\" id=\"removextra4\"><input type=\"hidden\" class=\"webbing\" name=\"webbing[63]\" value=\"\" readonly=\"readonly\" /></td>";
...
// Unit Quantity
echo "<td><input type=\"text\" id=\"addqty27\" name=\"qty[63]\" value=\"{$getQty[63]}\"></td>";
...
echo "<input type=\"hidden\" class=\"desc\" name=\"desc[64]\" value=\"".$extra['description']."\" readonly=\"readonly\" />".
	 ...
	 echo "</td>";
// Webbing
echo"<td><input type=\"button\" value=\"Remove Extras\" onclick=\"hidextra5();\" id=\"removextra5\"><input type=\"hidden\" class=\"webbing\" name=\"webbing[64]\" value=\"\" readonly=\"readonly\" /></td>";
...
// Unit Quantity
echo "<td><input type=\"text\" id=\"addqty28\" name=\"qty[64]\" value=\"{$getQty[64]}\"></td>";
...
echo "<td><input type=\"hidden\" name=\"id[65]\" value=\"{$getCFID[65]}\" /><select class=\"desclist\" name=\"desclist[]\" >"; 
		foreach($extras as $extra) {
      	echo "<option value=\"".$extra['cf_id']."\"";
		if($extra['cf_id'] == $getID[65]) {
		echo "selected=\"selected\""; 
		} else {echo "";}
		echo ">".$extra['description']."</option>";	
		}	
...
echo "<input type=\"hidden\" class=\"desc\" name=\"desc[65]\" value=\"".$extra['description']."\" readonly=\"readonly\" />".
     "<input type=\"hidden\" class=\"invent\" name=\"invent[65]\" value=\"".$extra['inventoryid']."\" readonly=\"readonly\" />".
     "<input type=\"hidden\" class=\"descrrp\" name=\"descrrp\" value=\"".$extra['rrp']."\" readonly=\"readonly\" />".
     "<input type=\"hidden\" class=\"desccost\" name=\"desccost\" value=\"".$extra['cost']."\" readonly=\"readonly\" />"; }
	 else {echo" ";}
	 }
...
echo "<input type=\"hidden\" class=\"desc\" name=\"desc[65]\" value=\"".$extra['description']."\" readonly=\"readonly\" />".
	 ...
	 echo "</td>";
// Webbing
echo"<td><input type=\"button\" value=\"Remove Extras\" onclick=\"hidextra6();\" id=\"removextra6\"><input type=\"hidden\" class=\"webbing\" name=\"webbing[65]\" value=\"\" readonly=\"readonly\" /></td>";
...
// Unit of Measurement
echo "<td><input type=\"text\" name=\"uom[65]\" class=\"uom\" readonly=\"readonly\" value=\"{$getUOM[65]}\"></td>";

// Unit Quantity
echo "<td><input type=\"text\" id=\"addqty29\" name=\"qty[65]\" value=\"{$getQty[65]}\"></td>";

// Length or Width
if ($getID[65] == '76') {
echo "<td><input type=\"text\" class=\"xlength\" name=\"slength[65]\" value=\"{$getLength[65]}\"></td>"; }
else {
echo "<td><input type=\"text\" class=\"xlength\" name=\"slength[65]\" value=\"{$getLength[65]}\" style=\"display:none;\"></td>";}

// Total RRP
echo "<td><input type=\"text\" class=\"rrp\" readonly=\"readonly\" name=\"rrp[65]\" value=\"{$getRRP[65]}\"><input type=\"hidden\" class=\"cst\" name=\"cst[65]\" value=\"${getCost[65]}\"></td></tr>";
...
echo "<td><input type=\"hidden\" name=\"id[66]\" value=\"{$getCFID[66]}\" /><select class=\"desclist\" name=\"desclist[]\" >"; 
		foreach($extras as $extra) {
      	echo "<option value=\"".$extra['cf_id']."\"";
		if($extra['cf_id'] == $getID[66]) {
		echo "selected=\"selected\""; 
		} else {echo "";}
		echo ">".$extra['description']."</option>";	
		}	
...
echo "<input type=\"hidden\" class=\"desc\" name=\"desc[66]\" value=\"".$extra['description']."\" readonly=\"readonly\" />".
     "<input type=\"hidden\" class=\"invent\" name=\"invent[66]\" value=\"".$extra['inventoryid']."\" readonly=\"readonly\" />".
     "<input type=\"hidden\" class=\"descrrp\" name=\"descrrp\" value=\"".$extra['rrp']."\" readonly=\"readonly\" />".
     "<input type=\"hidden\" class=\"desccost\" name=\"desccost\" value=\"".$extra['cost']."\" readonly=\"readonly\" />"; }
	 else {echo" ";}
	 }
...
echo "<input type=\"hidden\" class=\"desc\" name=\"desc[66]\" value=\"".$extra['description']."\" readonly=\"readonly\" />".
	 ...
	 echo "</td>";
// Webbing
echo"<td><input type=\"button\" value=\"Remove Extras\" onclick=\"hidextra7();\" id=\"removextra7\"><input type=\"hidden\" class=\"webbing\" name=\"webbing[66]\" value=\"\" readonly=\"readonly\" /></td>";
...
// Unit of Measurement
echo "<td><input type=\"text\" name=\"uom[66]\" class=\"uom\" readonly=\"readonly\" value=\"{$getUOM[66]}\"></td>";

// Unit Quantity
echo "<td><input type=\"text\" id=\"addqty30\" name=\"qty[66]\" value=\"{$getQty[66]}\"></td>";

// Length or Width
if ($getID[66] == '76') {
echo "<td><input type=\"text\" class=\"xlength\" name=\"slength[66]\" value=\"{$getLength[66]}\"></td>"; }
else {
echo "<td><input type=\"text\" class=\"xlength\" name=\"slength[66]\" value=\"{$getLength[66]}\" style=\"display:none;\"></td>";}

// Total RRP
echo "<td><input type=\"text\" class=\"rrp\" readonly=\"readonly\" name=\"rrp[66]\" value=\"{$getRRP[66]}\"><input type=\"hidden\" class=\"cst\" name=\"cst[66]\" value=\"${getCost[66]}\"></td></tr>";
...
echo "<td><input type=\"hidden\" name=\"id[67]\" value=\"{$getCFID[67]}\" /><select class=\"desclist\" name=\"desclist[]\" >"; 
		foreach($extras as $extra) {
      	echo "<option value=\"".$extra['cf_id']."\"";
		if($extra['cf_id'] == $getID[67]) {
		echo "selected=\"selected\""; 
		} else {echo "";}
		echo ">".$extra['description']."</option>";	
		}	
...
echo "<input type=\"hidden\" class=\"desc\" name=\"desc[67]\" value=\"".$extra['description']."\" readonly=\"readonly\" />".
     "<input type=\"hidden\" class=\"invent\" name=\"invent[67]\" value=\"".$extra['inventoryid']."\" readonly=\"readonly\" />".
     "<input type=\"hidden\" class=\"descrrp\" name=\"descrrp\" value=\"".$extra['rrp']."\" readonly=\"readonly\" />".
     "<input type=\"hidden\" class=\"desccost\" name=\"desccost\" value=\"".$extra['cost']."\" readonly=\"readonly\" />"; }
	 else {echo" ";}
	 }
...
echo "<input type=\"hidden\" class=\"desc\" name=\"desc[67]\" value=\"".$extra['description']."\" readonly=\"readonly\" />".
	 ...
	 echo "</td>";
// Webbing
echo"<td><input type=\"button\" value=\"Remove Extras\" onclick=\"hidextra8();\" id=\"removextra8\"><input type=\"hidden\" class=\"webbing\" name=\"webbing[67]\" value=\"\" readonly=\"readonly\" /></td>";
...
// Unit of Measurement
echo "<td><input type=\"text\" name=\"uom[67]\" class=\"uom\" readonly=\"readonly\" value=\"{$getUOM[67]}\"></td>";

// Unit Quantity
echo "<td><input type=\"text\" id=\"addqty31\" name=\"qty[67]\" value=\"{$getQty[67]}\"></td>";

// Length or Width
if ($getID[67] == '76') {
echo "<td><input type=\"text\" class=\"xlength\" name=\"slength[67]\" value=\"{$getLength[67]}\"></td>"; }
else {
echo "<td><input type=\"text\" class=\"xlength\" name=\"slength[67]\" value=\"{$getLength[67]}\" style=\"display:none;\"></td>";}

// Total RRP
echo "<td><input type=\"text\" class=\"rrp\" readonly=\"readonly\" name=\"rrp[67]\" value=\"{$getRRP[67]}\"><input type=\"hidden\" class=\"cst\" name=\"cst[67]\" value=\"${getCost[67]}\"></td></tr>";
...
echo "<td><input type=\"hidden\" name=\"id[68]\" value=\"{$getCFID[68]}\" /><select class=\"desclist\" name=\"desclist[]\" >"; 
		foreach($extras as $extra) {
      	echo "<option value=\"".$extra['cf_id']."\"";
		if($extra['cf_id'] == $getID[68]) {
		echo "selected=\"selected\""; 
		} else {echo "";}
		echo ">".$extra['description']."</option>";	
		}	
...
echo "<input type=\"hidden\" class=\"desc\" name=\"desc[68]\" value=\"".$extra['description']."\" readonly=\"readonly\" />".
     "<input type=\"hidden\" class=\"invent\" name=\"invent[68]\" value=\"".$extra['inventoryid']."\" readonly=\"readonly\" />".
     "<input type=\"hidden\" class=\"descrrp\" name=\"descrrp\" value=\"".$extra['rrp']."\" readonly=\"readonly\" />".
     "<input type=\"hidden\" class=\"desccost\" name=\"desccost\" value=\"".$extra['cost']."\" readonly=\"readonly\" />"; }
	 else {echo" ";}
	 }
...
echo "<input type=\"hidden\" class=\"desc\" name=\"desc[68]\" value=\"".$extra['description']."\" readonly=\"readonly\" />".
	 ...
	 echo "</td>";
// Webbing
echo"<td><input type=\"button\" value=\"Remove Extras\" onclick=\"hidextra9();\" id=\"removextra9\"><input type=\"hidden\" class=\"webbing\" name=\"webbing[68]\" value=\"\" readonly=\"readonly\" /></td>";
...
// Unit of Measurement
echo "<td><input type=\"text\" name=\"uom[68]\" class=\"uom\" readonly=\"readonly\" value=\"{$getUOM[68]}\"></td>";

// Unit Quantity
echo "<td><input type=\"text\" id=\"addqty32\" name=\"qty[68]\" value=\"{$getQty[68]}\"></td>";

// Length or Width
if ($getID[68] == '76') {
echo "<td><input type=\"text\" class=\"xlength\" name=\"slength[68]\" value=\"{$getLength[68]}\"></td>"; }
else {
echo "<td><input type=\"text\" class=\"xlength\" name=\"slength[68]\" value=\"{$getLength[68]}\" style=\"display:none;\"></td>";}

// Total RRP
echo "<td><input type=\"text\" class=\"rrp\" readonly=\"readonly\" name=\"rrp[68]\" value=\"{$getRRP[68]}\"><input type=\"hidden\" class=\"cst\" name=\"cst[68]\" value=\"${getCost[67]}\"></td></tr>";
...
echo "<td><input type=\"hidden\" name=\"id[69]\" value=\"{$getCFID[69]}\" /><select class=\"desclist\" name=\"desclist[]\" >"; 
		foreach($extras as $extra) {
      	echo "<option value=\"".$extra['cf_id']."\"";
		if($extra['cf_id'] == $getID[69]) {
		echo "selected=\"selected\""; 
		} else {echo "";}
		echo ">".$extra['description']."</option>";	
		}	
...
echo "<input type=\"hidden\" class=\"desc\" name=\"desc[69]\" value=\"".$extra['description']."\" readonly=\"readonly\" />".
     "<input type=\"hidden\" class=\"invent\" name=\"invent[69]\" value=\"".$extra['inventoryid']."\" readonly=\"readonly\" />".
     "<input type=\"hidden\" class=\"descrrp\" name=\"descrrp\" value=\"".$extra['rrp']."\" readonly=\"readonly\" />".
     "<input type=\"hidden\" class=\"desccost\" name=\"desccost\" value=\"".$extra['cost']."\" readonly=\"readonly\" />"; }
	 else {echo" ";}
	 }
...
echo "<input type=\"hidden\" class=\"desc\" name=\"desc[69]\" value=\"".$extra['description']."\" readonly=\"readonly\" />".
	 ...
	 echo "</td>";
// Webbing
echo"<td><input type=\"button\" value=\"Remove Extras\" onclick=\"hidextra10();\" id=\"removextra10\"><input type=\"hidden\" class=\"webbing\" name=\"webbing[69]\" value=\"\" readonly=\"readonly\" /></td>";
...
// Unit of Measurement
echo "<td><input type=\"text\" name=\"uom[69]\" class=\"uom\" readonly=\"readonly\" value=\"{$getUOM[69]}\"></td>";

// Unit Quantity
echo "<td><input type=\"text\" id=\"addqty33\" name=\"qty[69]\" value=\"{$getQty[69]}\"></td>";

// Length or Width
if ($getID[69] == '76') {
echo "<td><input type=\"text\" class=\"xlength\" name=\"slength[69]\" value=\"{$getLength[69]}\"></td>"; }
else {
echo "<td><input type=\"text\" class=\"xlength\" name=\"slength[69]\" value=\"{$getLength[69]}\" style=\"display:none;\"></td>";}

// Total RRP
echo "<td><input type=\"text\" class=\"rrp\" readonly=\"readonly\" name=\"rrp[69]\" value=\"{$getRRP[69]}\"><input type=\"hidden\" class=\"cst\" name=\"cst[69]\" value=\"${getCost[69]}\"></td></tr>";
...
echo "<td><input type=\"hidden\" name=\"id[70]\" value=\"{$getCFID[70]}\" /><select class=\"desclist\" name=\"desclist[]\" >"; 
		foreach($extras as $extra) {
      	echo "<option value=\"".$extra['cf_id']."\"";
		if($extra['cf_id'] == $getID[70]) {
		echo "selected=\"selected\""; 
		} else {echo "";}
		echo ">".$extra['description']."</option>";	
		}	
...
echo "<input type=\"hidden\" class=\"desc\" name=\"desc[70]\" value=\"".$extra['description']."\" readonly=\"readonly\" />".
     "<input type=\"hidden\" class=\"invent\" name=\"invent[70]\" value=\"".$extra['inventoryid']."\" readonly=\"readonly\" />".
     "<input type=\"hidden\" class=\"descrrp\" name=\"descrrp\" value=\"".$extra['rrp']."\" readonly=\"readonly\" />".
     "<input type=\"hidden\" class=\"desccost\" name=\"desccost\" value=\"".$extra['cost']."\" readonly=\"readonly\" />"; }
	 else {echo" ";}
	 }
...
echo "<input type=\"hidden\" class=\"desc\" name=\"desc[70]\" value=\"".$extra['description']."\" readonly=\"readonly\" />".
	 ...
	 echo "</td>";
// Webbing
echo"<td><input type=\"button\" value=\"Remove Extras\" onclick=\"hidextra11();\" id=\"removextra11\"><input type=\"hidden\" class=\"webbing\" name=\"webbing[70]\" value=\"\" readonly=\"readonly\" /></td>";
...
// Unit of Measurement
echo "<td><input type=\"text\" name=\"uom[70]\" class=\"uom\" readonly=\"readonly\" value=\"{$getUOM[70]}\"></td>";

// Unit Quantity
echo "<td><input type=\"text\" id=\"addqty34\" name=\"qty[70]\" value=\"{$getQty[70]}\"></td>";

// Length or Width
if ($getID[70] == '76') {
echo "<td><input type=\"text\" class=\"xlength\" name=\"slength[70]\" value=\"{$getLength[70]}\"></td>"; }
else {
echo "<td><input type=\"text\" class=\"xlength\" name=\"slength[70]\" value=\"{$getLength[70]}\" style=\"display:none;\"></td>";}

// Total RRP
echo "<td><input type=\"text\" class=\"rrp\" readonly=\"readonly\" name=\"rrp[70]\" value=\"{$getRRP[70]}\"><input type=\"hidden\" class=\"cst\" name=\"cst[70]\" value=\"${getCost[70]}\"></td></tr>";
