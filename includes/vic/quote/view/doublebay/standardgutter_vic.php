...
//error_log("Gutter 1: ".print_r($gutters,true), 3,'/home/vergola/public_html/quote-system/my-error.log');	
...
if ($getQty[20] != '0.00') {
	...
	echo "<tr id=\"stdgutter5\" style=\"display: table-row;\"><td><input type=\"hidden\" name=\"id[20]\" value=\"{$getCFID[20]}\" /><select class=\"desclist\" name=\"desclist[]\" >";
     	//error_log("Gutter 2: ".print_r($gutters,true), 3,'/home/vergola/public_html/quote-system/my-error.log');	
		foreach($gutters as $gutter) {
      	echo "<option value=\"".$gutter['cf_id']."\"";
