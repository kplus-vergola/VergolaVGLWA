...
if(isset($_POST['save-close-doublebay']))
{	
...
// ***************************** 1 -Cbeam 200 Deep by 2.4mm ***********************************************//
echo "<tr><td colspan=\"8\" class=\"subheading\">Framework</td></tr>";
$resultcbeam200 = mysql_query("SELECT cf_id, inventoryid, description, uom, rrp, cost FROM ver_chronoforms_data_inventory_vic WHERE section = 'Frame' and category = 'CBeams' or category = 'Timber'" ); //or category = 'Beams'
...
echo "</select>";
$datacbeam = mysql_query("SELECT cf_id, inventoryid, description, uom, rrp, cost  FROM ver_chronoforms_data_inventory_vic WHERE  cf_id = '1'" );
...
// Length or Width
echo"<td><input type=\"text\"  name=\"slength[]\" class=\"length2\" value=\"0\"></td>";

// Total RRP
echo "<td><input type=\"text\" class=\"rrp\" readonly=\"readonly\" name=\"rrp[]\" value=\"\"><input type=\"hidden\" class=\"cst\" name=\"cst[]\" value=\"\"></td></tr>";


// ***************************** 3 - Cbeam 250 Deep by 2.4mm ********************************************//
...
// ***************************** 4 - Intermediate 250 Deep by 2.4mm ********************************************//

$resultinter = mysql_query("SELECT cf_id, inventoryid, description, uom, rrp, cost FROM ver_chronoforms_data_inventory_vic WHERE section = 'Frame' and category  = 'Intermediate'" );
echo "<tr><td><select class=\"desclist\" name=\"desclist[]\" >";

		while ($inter250 = mysql_fetch_array($resultinter)) {
		$heading =  isset($inter250[0]) ? $inter250[0] : null;
		$BeamIDArrayPhp .= isset($inter250[1]) ? 'BeamIDArray["'.$heading.'"]="'.$inter250[1].'";' : null;	
		$BeamDESCArrayPhp .= isset($inter250[2]) ? 'BeamDESCArray["'.$heading.'"]="'.$inter250[2].'";' : null;
		$BeamRRPArrayPhp .= isset($inter250[4]) ? 'BeamRRPArray["'.$heading.'"]="'.$inter250[4].'";' : null;
		$BeamCOSTArrayPhp .= isset($inter250[5]) ? 'BeamCOSTArray["'.$heading.'"]="'.$inter250[5].'";' : null;
      	echo "<option value=\"".$inter250['cf_id']."\"";
		if($inter250['cf_id'] == $Inter250ID) { echo "selected=\"selected\""; } echo ">".$inter250['description']."</option>";	
		}	

echo "</select>";
    
	 $datainter250 = mysql_query("SELECT cf_id, inventoryid, description, uom, rrp, cost FROM ver_chronoforms_data_inventory_vic WHERE section = 'Frame' and category  = 'Intermediate' and cf_id = '111'" );
	 $retinter250 = mysql_fetch_array($datainter250);
	 
echo "<input type=\"hidden\" class=\"desc\" name=\"desc[]\" value=\"".$retinter250['description']."\" readonly=\"readonly\" />".
     "<input type=\"hidden\" class=\"invent\" name=\"invent[]\" value=\"".$retinter250['inventoryid']."\" readonly=\"readonly\" />".
     "<input type=\"hidden\" class=\"descrrp\" name=\"descrrp\" value=\"".$retinter250['rrp']."\" readonly=\"readonly\" />".
     "<input type=\"hidden\" class=\"desccost\" name=\"desccost\" value=\"".$retinter250['cost']."\" readonly=\"readonly\" /></td>";
...
// Unit of Measurement
$resultbeam = mysql_query("SELECT cf_id, inventoryid, description, uom, rrp, cost FROM ver_chronoforms_data_inventory_vic WHERE section = 'Frame' and category  = 'Beams' and cf_id = '4'" );
echo "<td>";
     while ($beam = mysql_fetch_array($resultbeam)) {
...
// ***************************** 6 - Intermediate Corner ********************************************//

$resultbeam = mysql_query("SELECT cf_id, inventoryid, description, uom, rrp, cost FROM ver_chronoforms_data_inventory_vic WHERE   cf_id = '108'" );
echo "<tr><td>";
...
$resultfix = mysql_query("SELECT cf_id, inventoryid, description, uom, rrp, cost FROM ver_chronoforms_data_inventory_vic WHERE section = 'Fixings' and cf_id = '20'" );
echo "<tr><td>";
...
$resultfix = mysql_query("SELECT cf_id, inventoryid, description, uom, rrp, cost FROM ver_chronoforms_data_inventory_vic WHERE section = 'Fixings' and cf_id = '21'" );
echo "<tr><td>";
...
$resultfix = mysql_query("SELECT cf_id, inventoryid, description, uom, rrp, cost FROM ver_chronoforms_data_inventory_vic WHERE section = 'Fixings' and cf_id = '22'" );
echo "<tr><td>";
...
$resultfix = mysql_query("SELECT cf_id, inventoryid, description, uom, rrp, cost FROM ver_chronoforms_data_inventory_vic WHERE section = 'Fixings' and cf_id = '23'" );
echo "<tr><td>";
...
$resultfix = mysql_query("SELECT cf_id, inventoryid, description, uom, rrp, cost FROM ver_chronoforms_data_inventory_vic WHERE section = 'Fixings' and cf_id = '24'" );
echo "<tr><td>";
...
$resultfix = mysql_query("SELECT cf_id, inventoryid, description, uom, rrp, cost FROM ver_chronoforms_data_inventory_vic WHERE section = 'Fixings' and cf_id = '25'" );
echo "<tr><td>";
...
$resultfix = mysql_query("SELECT cf_id, inventoryid, description, uom, rrp, cost FROM ver_chronoforms_data_inventory_vic WHERE section = 'Fixings' and cf_id = '26'" );
echo "<tr><td>";
...
// ***************************** First Standard Vergola Gutter Lip Out 200 x 200 - Length 2 ********************************************//

echo "<tr id=\"stdgutter1-2\" style=\"display: table-row;\"><td><select class=\"desclist\" name=\"desclist[]\" >";
        $resultgutter = mysql_query("SELECT cf_id, inventoryid, description, uom, rrp, cost FROM ver_chronoforms_data_inventory_vic WHERE section = 'Guttering' and category  = 'Gutters Standard'" );
		while ($gutter = mysql_fetch_array($resultgutter)) {
		include "standardgutter_vic.php";
      	echo "<option value=\"".$gutter['cf_id']."\"";
...
echo "</td>";
 ...
 // Unit Quantity
echo "<td><input type=\"text\" id=\"addqty7-2\" name=\"qty[]\" value=\"1\"></td>";

// Length or Width
echo "<td><input type=\"text\" class=\"length2\" name=\"slength[]\" value=\"0\"></td>";

// Total RRP
echo "<td><input type=\"text\" class=\"rrp\" readonly=\"readonly\" name=\"rrp[]\" value=\"\"><input type=\"hidden\" class=\"cst\" name=\"cst[]\" value=\"\"></td></tr>";

// ***************************** Second Standard Vergola Gutter Lip Out 250 x 250 - Length 2 ********************************************//

echo "<tr id=\"stdgutter2-2\" style=\"display: table-row;\"><td><select class=\"desclist\" name=\"desclist[]\" >";
     $resultgutter = mysql_query("SELECT cf_id, inventoryid, description, uom, rrp, cost FROM ver_chronoforms_data_inventory_vic WHERE section = 'Guttering' and category  = 'Gutters Standard'" );
		while ($gutter = mysql_fetch_array($resultgutter)) {
		include "standardgutter_vic.php";
      	echo "<option value=\"".$gutter['cf_id']."\"";
...
echo "<td><input type=\"text\" id=\"addqty8-2\" name=\"qty[]\" value=\"1\"></td>";
