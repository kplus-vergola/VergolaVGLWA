...
//error_log("cbeam200 :".$cbeam200['cf_id']. " ----- cbeam200ID: ".$cbeam200ID, 3,'C:\\xampp\htdocs\\vergola_contract_system_v3\\my-error.log');
echo "<table id=\"singlebay-table\" class=\"listing-table\"><tr><th>Description</th><th>Webbing</th><th>Colour</th><th>Finish</th><th>UOM</th><th>QTY</th><th>Length</th><th>RRP</th></tr>";
...
echo "<tr><td><select class=\"desclist\" name=\"desclist[]\" >"; 
		...
		while ($cbeam200 = mysql_fetch_assoc($resultcbeam200)) {
			//error_log(print_r(mysql_fetch_array($resultcbeam200),true), 3,'C:\\xampp\htdocs\\vergola_contract_system_v3\\my-error.log'); 	
			//error_log("cbeam200 :".$cbeam200['cf_id']. " == cbeam200ID: ".$cbeam200ID, 3,'C:\\xampp\htdocs\\vergola_contract_system_v3\\my-error.log');
...
echo "</select>";
$datacbeam = mysql_query("SELECT cf_id, inventoryid, description, uom, rrp, cost  FROM ver_chronoforms_data_inventory_vic WHERE  cf_id = '1'" ); //section = 'Frame' and category  = 'CBeams' and
...
echo "</select>";
	 ...
	 $datacbeam250 = mysql_query("SELECT cf_id, inventoryid, description, uom, rrp, cost FROM ver_chronoforms_data_inventory_vic WHERE cf_id = '3'" ); //section = 'Frame' and category  = 'CBeams' and 
