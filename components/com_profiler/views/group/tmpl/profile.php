 ...
 * @version $Id: profile.php 12 2013-03-28 18:07:09Z harold $
 * @author Harold Prins
...
<form action="<?php echo JRoute::_('index.php?option=com_profiler&view=user&id='.(int) $this->item->groupid); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="profiler-user" class="form-validate">
		<div class="row-fluid">
			<div class="hero-unit">
				<div class="row">
					<div class="span3">
		...
		<div class="row-fluid">
			<div class="form-actions">
				<?php if (JRequest::getCmd('ro')){
					if($this->menu) { ?>
						<input type="button" class="btn btn-primary" onclick="location.href='<?php echo JRoute::_(ProfilerHelperRoute::getGroupRoute($this->item->groupid, false)); ?>'" value="<?php echo JText::_("COM_PROFILER_EDIT") ?>" />
					<?php } ?>
					<input type="hidden" name="task" value="" />
				<?php } elseif (!JRequest::getCmd('ro')) { ?>
					<button type="submit" class="btn btn-primary validate"><?php echo $this->item->groupid ? JText::_('JSAVE') : JText::_('JREGISTER');?></button>
