 ...
 * @version $Id: default.php 42 2013-04-26 16:03:35Z harold $
 * @author Harold Prins
	...
	<div class="row-fluid">
	  <div class="span12 well">
		<div class="form-inline pull-right">
			...
			<select name="filter_searchgroupid" class="input-small" onchange="this.form.submit()">
		...
		<?php if ($this->params->def('downloadenable', 1)) : ?>
			<button class="btn" type="button" onclick="document.id('task').value='excel';document.id('format').value='raw';this.form.submit();document.id('task').value='';document.id('format').value='html';"><?php echo JText::_('COM_PROFILER_DOWNLOAD'); ?></button>
		<?php endif; ?>
