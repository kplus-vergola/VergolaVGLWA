 ...
 * @version $Id: view.html.php 13 2013-04-26 15:59:36Z harold $
 * @author Harold Prins
...
class ProfilerViewGroups extends JViewLegacy
{
	...
	function display($tpl = null)
	{
		...
		if ($params->get("grouplayout")) {
			$this->setLayout($params->get("grouplayout"));
		}
	...
	{
		$table = $this->params->get('grouptable');
	...
	protected function _prepareOrdering()
	{
		...
		$ordering = explode(",", $this->params->get('groupsort'));
