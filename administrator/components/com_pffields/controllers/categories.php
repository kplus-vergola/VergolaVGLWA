...
class PffieldsControllerCategories extends JControllerAdmin
{
	protected $text_prefix = 'COM_PFFIELDS_FIELDS';

	public function getModel($name = 'Category', $prefix = 'PffieldsModel', $config = array('ignore_request' => true))
	{
