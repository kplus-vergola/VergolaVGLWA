        function assignVrDimensionsToVrYFormGutterRows() {
            var temp_array = [];
            ...
            for (c1 = 0; c1 < vr_lengths_meter_in_value_for_display.length; c1++) {
                ...
                setVrFormItemDataEntryRowValuesByInternalRefName(
                    'gutter_narrow' + current_bay_ref_suffix, 
                ...
                setVrFormItemDataEntryRowValuesByInternalRefName(
                    'gutter_wide' + current_bay_ref_suffix, 
                    [{"form_item_name":"vr_item_data_entry_length_meter", "variable_name":"vr_item_length_meter", "col_value":vr_lengths_meter_in_value_for_display[c1]}]
                );

                if (vr_type_form_query_value == 'VR8') {
                    setVrFormItemDataEntryRowValuesByInternalRefName(
                        'gutter_narrow' + current_bay_ref_suffix + '_1', 
                        [{"form_item_name":"vr_item_data_entry_length_meter", "variable_name":"vr_item_length_meter", "col_value":vr_lengths_meter_in_value_for_display[c1]}]
                    );

                    setVrFormItemDataEntryRowValuesByInternalRefName(
                        'gutter_narrow' + current_bay_ref_suffix + '_2', 
                        [{"form_item_name":"vr_item_data_entry_length_meter", "variable_name":"vr_item_length_meter", "col_value":vr_lengths_meter_in_value_for_display[c1]}]
                    );

                    setVrFormItemDataEntryRowValuesByInternalRefName(
                        'gutter_narrow' + current_bay_ref_suffix + '_3', 
            ...
            setVrFormItemDataEntryRowValuesByInternalRefName(
                'gutter_tapered_narrow_to_wide', 
                [{"form_item_name":"vr_item_data_entry_length_meter", "variable_name":"vr_item_length_meter", "col_value":vr_width_meter_in_value_for_display}]
            );

            setVrFormItemDataEntryRowValuesByInternalRefName(
                'gutter_tapered_wide_to_narrow', 
                [{"form_item_name":"vr_item_data_entry_length_meter", "variable_name":"vr_item_length_meter", "col_value":vr_width_meter_in_value_for_display}]
            );
        }


        function assignVrDimensionsToVrYFormFlashingRows() {
            var temp_array = [];
            var vr_lengths_in_value_for_calculation = [];
            var vr_lengths_meter_in_value_for_display = [];
            var total_vr_length_meter_in_value_for_display = '';
        ...
        function assignVrDimensionsToVrYFormLouvreRows() {
            var temp_array = [];
            var vr_lengths_in_value_for_calculation = [];
            var vr_lengths_meter_in_value_for_display = [];
            var total_vr_length_meter_in_value_for_display = '';
            ...
            for (c1 = 0; c1 < vr_lengths_meter_in_value_for_display.length; c1++) {
                ...
                total_louvre = Math.floor(vr_lengths_in_value_for_calculation[c1] / minimum_meter_per_louvre);
        ...
        function assignVrDimensionsToVrYFormRelatedRows() {
            assignVrDimensionsToVrYFormGutterRows();
            assignVrDimensionsToVrYFormFlashingRows();
            assignVrDimensionsToVrYFormLouvreRows();
        }
