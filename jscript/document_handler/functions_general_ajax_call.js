        ...
        function respondAjaxCall(ajax_call_handler_index, respond_type, data, respond_method_name) {
            ...
            if (debug_mode_enabled == 'y') {
                console.log('respondAjaxCall > data:');
                console.log(data);
            }
        ...
        function requestAjaxCall(url, data, respond_method_name) {
            ...
            if (data['access_mode'] == 'file_upload') {
                ajax_call_handler[ajax_call_handler_new_index].send(data['form_data']);
            } else {
        ...
        var ajax_call_timer = [];
        var ajax_call_state = '';
        var ajax_call_max_wait_time_in_seconds = 5000;
