...
var Beam = $(this).val(); console.log(BeamDESCArray);
...
var Beam = $(this).val();
$('#desc5').val(BeamDESCArray[Beam]); 
$('#invent5').val(BeamIDArray[Beam]); 
$('#descrrp5').val(BeamRRPArray[Beam]);
$('#desccost5').val(BeamCOSTArray[Beam]);
}); 
...
var Beam = $(this).val();
$('#desc6').val(BeamDESCArray[Beam]); 
$('#invent6').val(BeamIDArray[Beam]); 
$('#descrrp6').val(BeamRRPArray[Beam]);
$('#desccost6').val(BeamCOSTArray[Beam]);
}); 
...
var Beam = $(this).val();
$('#desc17').val(BeamDESCArray[Beam]); 
$('#invent17').val(BeamIDArray[Beam]); 
$('#descrrp17').val(BeamRRPArray[Beam]);
$('#desccost17').val(BeamCOSTArray[Beam]);
}); 
...
var Beam = $(this).val();
$('#desc18').val(BeamDESCArray[Beam]); 
$('#invent18').val(BeamIDArray[Beam]); 
$('#descrrp18').val(BeamRRPArray[Beam]);
$('#desccost18').val(BeamCOSTArray[Beam]);
}); 
...
var Beam = $(this).val();
$('#desc19').val(BeamDESCArray[Beam]); 
$('#invent19').val(BeamIDArray[Beam]); 
$('#descrrp19').val(BeamRRPArray[Beam]);
$('#desccost19').val(BeamCOSTArray[Beam]);
}); 
...
$("#totalrrpid").val((Math.ceil(addrrp + addrrpd)).toFixed(2));
