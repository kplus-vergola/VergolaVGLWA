$(document).ready(function(){  
	...
	$("#lengthid, #widthid").change(function(){  
        ...
        $("#output .rrp").each(function(e){  
			...
			var webbingRrp = 0;
	 		...
	 		if((selectedFramework == "Single Bay VR1" || selectedFramework == "Single Bay VR1 - Drop-In") && category == "Louvers"){  //|| id == "IRV31"
	 		...
	 		}else if((selectedFramework == "Single Bay VR0" || selectedFramework == "Single Bay VR0 - Drop-In") && category == "Louvers"){
	...
	$(document).on("change","#output select.desclist, #output select.paint-list, #output select.webbing-list",function(e){ //alert("trigger here2");
	...
	$("#louvres-len, #louvres-qty").change(function(){ //alert("running here2");
